 ...
 */
export class SandboxDesignerGuard extends AbstractGuardService implements CanActivate {
    constructor(
        router: Router,
    ...
    protected hasRole = () => RoleResolver.isSandboxDesigner(this.authService.getRoles());
}
