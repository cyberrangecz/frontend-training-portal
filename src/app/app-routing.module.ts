...
import {
  HOME_PATH, LOGIN_PATH, NOTIFICATIONS_PATH,
} from './paths';
...
const routes: Routes = [
  ...
  {
    path: USER_PATH,
    loadChildren: () => import('./modules/user-and-group-agenda/user/user-overview.module').then(m => m.UserOverviewModule),
  ...
  {
    path: GROUP_PATH,
    loadChildren: () => import('./modules/user-and-group-agenda/group/group-overview.module').then(m => m.GroupOverviewModule),
    canActivate: [UserAndGroupGuard],
    data: {
      breadcrumb: 'Groups',
  ...
  },
  {
    ...
    loadChildren: () => import('./modules/user-and-group-agenda/microservice/new/microservice-new.module').then(m => m.MicroserviceNewModuleModule),
    canActivate: [UserAndGroupGuard],
    data: {
