module.exports = function () {
    return {
            ...
            roles: [
                {
                    ...
                    name_of_microservice: 'training',
                    description:
                        'This role will allow you to manage, test, import and export training definitions and assign organizers to beta testing group in CyberRangeᶜᶻ Platform Training.',
                    role_type: 'ROLE_TRAINING_DESIGNER',
                },
                {
                    id: 2,
                    id_of_microservice: 1,
                    name_of_microservice: 'user-and-group',
                ...
                },
                {
                    ...
                    name_of_microservice: 'sandbox_service',
                    description: null,
                    role_type: 'ROLE_SANDBOX_SERVICE_PROJECT_ADMIN',
                },
                {
                    id: 7,
                    id_of_microservice: 2,
                    name_of_microservice: 'training',
                    description: 'This role will allow you to do every operation in CyberRangeᶜᶻ Platform Training.',
                ...
                },
                {
                    ...
                    name_of_microservice: 'sandbox_service',
                    description: null,
                    role_type: 'ROLE_SANDBOX_SERVICE_PROJECT_ORGANIZER',
                },
                {
                    id: 8,
                    id_of_microservice: 3,
                    name_of_microservice: 'sandbox_service',
                    description: null,
                    role_type: 'ROLE_SANDBOX_SERVICE_PROJECT_DESIGNER',
                },
                {
                    id: 9,
                    id_of_microservice: 3,
                    name_of_microservice: 'sandbox_service',
                    description: null,
                    role_type: 'ROLE_SANDBOX_SERVICE_PROJECT_TRAINEE',
                },
                {
                    id: 1,
                    id_of_microservice: 1,
                    name_of_microservice: 'user-and-group',
                    description: 'This role will allow you to create, edit, delete and manage users, groups and roles in CyberRangeᶜᶻ Platform.',
                ...
                },
                {
                    ...
                    name_of_microservice: 'training',
                    description:
                        'This role is default and will allow you to access training run and play a training in CyberRangeᶜᶻ Platform Training.',
                ...
                },
                {
                    ...
                    name_of_microservice: 'training',
                    description:
                        'This role will allow you to prepare training instances from training definitions and manage them, restart sandbox instances and view situational awareness in CyberRangeᶜᶻ Platform Trainings.',
                    role_type: 'ROLE_TRAINING_ORGANIZER',
                },
            ],
            iss: 'https://oidc.provider.cz/oidc/',
            picture:
            ...
            "results": [
                {
                    ...
                    "created_by": {
                        "id": 3,
                        "sub": "user-3|https://stage.platform.cyberrange.cz:443/dummy-issuer-server",
                ...
                },
                {
                    ...
                    "created_by": {
                        "id": 5,
                        "sub": "user-1|https://stage.platform.cyberrange.cz:443/dummy-issuer-server",
                    ...
                    roles: [
                        {
                            ...
                            name_of_microservice: 'training',
                            description:
                                'This role will allow you to manage, test, import and export training definitions and assign organizers to beta testing group in CyberRangeᶜᶻ Platform Trainings.',
                            role_type: 'ROLE_TRAINING_DESIGNER',
                        },
                        {
                            id: 2,
                        ...
                        },
                        {
                            id: 8,
                            id_of_microservice: 3,
                            name_of_microservice: 'django_openstack',
                            description: null,
                            role_type: 'ROLE__DJANGO_OPENSTACK_ADMIN',
                        },
                        {
                            id: 7,
                            id_of_microservice: 2,
                        ...
                        },
                        {
                            ...
                            name_of_microservice: 'django_openstack',
                            description: null,
                            role_type: 'ROLE__DJANGO_OPENSTACK_TRAINEE',
                        },
                        {
                            id: 15,
                            ...
                            name_of_microservice: 'django_openstack',
                            description: null,
                            role_type: 'ROLE__DJANGO_OPENSTACK_PROJECT_DESIGNER',
                        },
                        {
                            id: 10,
                            id_of_microservice: 3,
                            name_of_microservice: 'django_openstack',
                            description: null,
                            role_type: 'ROLE__DJANGO_OPENSTACK_DESIGNER',
                        },
                        {
                            id: 12,
                            id_of_microservice: 4,
                            name_of_microservice: 'django_openstack',
                            description: null,
                            role_type: 'ROLE__DJANGO_OPENSTACK_PROJECT_TRAINEE',
                        },
                        {
                            id: 17,
                            id_of_microservice: 5,
                            name_of_microservice: 'topology',
                            description: null,
                        ...
                        },
                        {
                            ...
                            name_of_microservice: 'django_openstack',
                            description: null,
                            role_type: 'ROLE__DJANGO_OPENSTACK_PROJECT_ORGANIZER',
                        },
                        {
                            id: 1,
                            id_of_microservice: 1,
                            name_of_microservice: 'user-and-group',
                            description:
                                'This role will allow you to create, edit, delete and manage users, groups and roles in CyberRangeᶜᶻ Platform.',
                            role_type: 'ROLE_USER_AND_GROUP_ADMINISTRATOR',
                        },
                        {
                            id: 3,
                        ...
                        },
                        {
                            ...
                            name_of_microservice: 'training',
                            description:
                                'This role is default and will allow you to access training run and play a training in CyberRangeᶜᶻ Platform Trainings.',
                            role_type: 'ROLE_TRAINING_TRAINEE',
                        },
                        {
                            id: 4,
                        ...
                        },
                        {
                            ...
                            name_of_microservice: 'django_openstack',
                            description: null,
                            role_type: 'ROLE__DJANGO_OPENSTACK_PROJECT_ADMIN',
                        },
                        {
                            id: 9,
                            id_of_microservice: 3,
                            name_of_microservice: 'django_openstack',
                            description: null,
                            role_type: 'ROLE__DJANGO_OPENSTACK_ORGANIZER',
                        },
                    ],
                    iss: 'https://oidc.provider.cz/oidc/',
                    picture:
        ...
        user: {
            ...
            "sub": "joe@example.cz",
            "iss": "https://oidc.provider.cz/oidc/",
            "full_name": "Dr. Joe Freeman",
            "mail": "joe@mail.muni.cz",
            "given_name": "Joe",
            "family_name": "Freeman",
            "roles": [{
                "id": 2,
                ...
                "id": 8,
                "id_of_microservice": 3,
                "name_of_microservice": "adaptive-training",
                ...
                "id_of_microservice": 4,
                "name_of_microservice": "training",
                "description": "This role will allow you to prepare training instances from training definitions and manage them, restart sandbox instances and view situational awareness in CyberRangeᶜᶻ Platform Trainings.",
                "role_type": "ROLE_TRAINING_ORGANIZER"
            }, {
                "id": 14,
                "id_of_microservice": 4,
                "name_of_microservice": "training",
                "description": "This role is default and will allow you to access training run and play a training in CyberRangeᶜᶻ Platform Trainings.",
                "role_type": "ROLE_TRAINING_TRAINEE"
            }, {
                "id": 3,
                "id_of_microservice": 1,
                ...
                "id": 5,
                "id_of_microservice": 2,
                "name_of_microservice": "sandbox-service",
                "description": null,
                "role_type": "ROLE_SANDBOX-SERVICE_ADMIN"
            }, {
                "id": 7,
                "id_of_microservice": 2,
                "name_of_microservice": "sandbox-service",
                "description": null,
                "role_type": "ROLE_SANDBOX-SERVICE_TRAINEE"
            }, {
                "id": 9,
                "id_of_microservice": 3,
                "name_of_microservice": "adaptive-training",
                ...
                "name_of_microservice": "sandbox-service",
                "description": null,
                "role_type": "ROLE_SANDBOX-SERVICE_DESIGNER"
            }, {
                "id": 11,
                "id_of_microservice": 3,
                "name_of_microservice": "adaptive-training",
                ...
                "id_of_microservice": 4,
                "name_of_microservice": "training",
                "description": "This role will allow you to manage, test, import and export training definitions and assign organizers to beta testing group in CyberRangeᶜᶻ Platform Trainings.",
                "role_type": "ROLE_TRAINING_DESIGNER"
            }, {
                "id": 10,
                "id_of_microservice": 3,
        ...
        microservices: {
            content: [{
                ...
                endpoint: "BASE_URL:8082/adaptive-training/api/v1/"
            }, {
                id: 2,
                name: "sandbox-service",
                endpoint: "sandbox_service_project"
            }, {
                id: 4,
                name: "training",
                endpoint: "BASE_URL:8083/training/api/v1/"
            }, {
                id: 1,
                name: "user-and-group",
                endpoint: "BASE_URL:8084/user-and-group/api/v1/"
            }],
            pagination: {
                number: 0,
        ...
        apiInfo: {
            "project_name": "platform-staging",
            "quotas": {
                "vcpu": {"limit": 100.0, "in_use": 65.0},
                "ram": {"limit": 409.6, "in_use": 157.7},
                "instances": {"limit": 100.0, "in_use": 44.0},
                "network": {"limit": 200.0, "in_use": 38.0},
                "subnet": {"limit": 200.0, "in_use": 36.0},
                "port": {"limit": 800.0, "in_use": 153.0}
            }
        },
        pools: {
            "page": 1,
            ...
            "results": [
                ...
                },
                {
                    ...
                    "created_by": {
                        "id": 2,
                        "sub": "111@example.cz|https://oidc.provider.cz/oidc",
                        "full_name": "User Gen",
                        "given_name": "User",
                        "family_name": "Gen",
                    ...
                    "definition": {
                        "id": 9,
                        "name": "junior-hacker-adaptive",
                        "url": "https://github.com/cyberrangecz/library-junior-hacker-adaptive.git",
                        "rev": "master",
                        "created_by": {
                            "id": 2,
                            "sub": "445519@example.cz|https://oidc.test.cz/oidc",
                            "full_name": "User Gen",
                            "given_name": "User",
                            "family_name": "Gen",
                            "mail": "111@mail.muni.cz"
                ...
                },
                {
                    ...
                    "definition": {
                        ...
                        "created_by": {
                            "id": 2,
                            "sub": "445519@example.cz|https://oidc.provider.cz/oidc",
                            "full_name": "User Gen",
                            "given_name": "User",
                            "family_name": "Gen",
                            "mail": "111@mail.muni.cz"
